<template>
    <div class="filter-container">
        <div class="locationBtn-container">
        ...
        <div class="furniture-enter-container">
...
<style>
    ...
    .location, .rooms, .price, .furniture{
        width: 100%;
        height: 100%;
    ...
    .location:hover, .rooms:hover, .price:hover, .furniture:hover {
